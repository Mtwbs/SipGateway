...
public class test implements SipListener {
    ...
    public static String localIP= "192.168.0.181";
 ...
 //   protected Dialog dialog;
   ...
   */ 
    ...
    {
      test.IPcallee = IPcallee;    
      
      test.RTPportcallee = RTPportcallee;
      test.RTCPportcallee = RTCPportcallee;
    ...
    public int processRefer(RequestEvent requestEvent, ServerTransaction serverTransaction)
    	    throws ParseException, SipException, InvalidArgumentException
    	  {
    	    ...
    	    if (dialog != null)
    	    {
    	      ...
    	      System.out.println("Dialog state " + dialog.getState());
    	      System.out.println("test tag=" + dialog.getLocalTag());
     ...
     void SendRedirect() {
      ...
      /*    sdpData = "v=0\r\n"
          ...
          //        + "b=AS:25.4\r\n";
                  ...
                  + "a=curr:qos test none\r\n"
                  + "a=curr:qos remote none\r\n"
                  + "a=des:qos mandatory test sendrec\r\n"
   ...
   */
    ...
    public static void SDPParser(String sdpData)
    	    throws ParseException, SdpException
    	  {
    	    ...
    	    new test().recordingSocket(sessiondescription1.getConnection().toString().split("IN IP4 ")[1], md.getMedia().toString().split("m=audio | RTP")[1], md.getAttribute("rtcp"));
